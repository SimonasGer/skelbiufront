    ...
    return(
        <div className="d-flex flex-column align-items-center">
            ...
            <form className="my-5 w-100" onSubmit={handleSubmit}>
                <fieldset className="container d-flex justify-content-center ">
                    <div className="d-flex flex-column align-items-center w-50">
                        ...
                        <select className="w-100 m-3 form-control" name="category" id="category" onChange={handleChange}>
            ...
            <form className="my-5 w-100" onSubmit={handleSubmitCat}>
                <fieldset className="container d-flex justify-content-center ">
                    <div className="d-flex flex-column align-items-center w-50">
                        <input className="w-100 m-3 form-control" name="category" id="category" type="text" placeholder="Category" value={category} onChange={(e) => {setCategory(e.target.value)}}/>
                        <button className="w-100 m-3 btn btn-success" type="submit">Add category</button>
                    </div>
                </fieldset>
            </form>}
        </div>
